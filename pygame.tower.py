...
def menu_screen():  # to be called before starting actual game loop
    ...
    while not menu_done:  # every screen/scene/level has its own loop
        ...
        blit_text(screen, str(n_disks), (320, 260), font_name='sans serif', size=50, color=blue)
        blit_text(screen, 'Press ENTER to continue', (320, 320), font_name='sans_serif', size=30, color=white)
...
def game_over(): # game over screen
    ...
    if min_steps==steps:
        blit_text(screen, 'You finished in minumum steps!kesah sahbi ', (320, 300), font_name='sans serif', size=24, color=green)
    pygame.display.flip()
